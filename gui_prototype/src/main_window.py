...
from ui_helpers import (
    ...
    ElidedLabel,
    MetricCard,
    PreferredHeightSplitter,
    VerticalOnlyScrollArea,
    panel,
)
...
class MainWindow(QMainWindow):
    ...
    def _build_ble_connection_panel(self) -> QWidget:
        frame, layout = panel("BLE Connection", "Scan and connect to a wireless sensor.")
    ...
    def _build_wired_connection_panel(self) -> QWidget:
        frame, layout = panel("Wired Connection", "Connect through a COM-style serial link.")
        row = QHBoxLayout()
        row.setSpacing(8)
    ...
    def _build_controls_panel(self) -> QWidget:
        frame, layout = panel("Controls", "Commands are routed through the shared controller layer.")
    ...
    def _build_recording_panel(self) -> QWidget:
        frame, layout = panel("Recording", "Session files are written as .partial.csv and finalized to .csv on stop.")
    ...
    def _build_right_column(self) -> QWidget:
        ...
        self.plot_toolbar, toolbar_layout = panel(
            "Plot Toolbar",
        ...
        sensor_frame, sensor_layout = panel("Flow / O2 Concentration", "Blue: flow rate, orange: O2 concentration when calibrated.")
        ...
        heater_frame, heater_layout = panel("Zirconia Output Voltage / Heater RTD Resistance")
