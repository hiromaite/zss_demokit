...
| `GUI-VAL-040` | Release readiness metadata / document smoke | beta4 packaging metadata、icon assets、PyInstaller spec、release docs の整合を機械的に確認できる | `PASS` | `tools/release_readiness_check.py` を追加し、`APP_VERSION=0.1.0-beta.4`、`zss_demokit_gui_win64_beta4`、icon、spec hiddenimports、`README.md`、`AGENTS.md`、`docs/project_status_v1.md`、`docs/distribution_plan_v1.md`、`docs/release_notes_beta4.md`、Windows smoke checklist 参照を確認 |
