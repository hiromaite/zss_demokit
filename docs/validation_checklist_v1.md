...
| `GUI-VAL-028` | Cross-resolution layout smoke | Windows / low-resolution / narrow window で left/right scroll、plot height、log height、splitter が破綻しない | `PASS` | `tools/gui_layout_smoke.py` で `1480x940` / `1366x768` / `1280x720` / `1024x700` を確認。left/right horizontal scroll なし、metric cards 1 row、plot splitter height `600px`、splitter resize response を確認 |
