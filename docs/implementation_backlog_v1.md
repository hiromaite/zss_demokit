...
- current focus は feature extension bundle の継続実装であり、`EXT-002` を close したため次は `EXT-003` O2 1-cell display and calibration が先頭タスクである
...
3. `EXT-003` O2 1-cell display and calibration `NEXT`
