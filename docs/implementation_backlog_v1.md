...
- BLE / wired decoder は bit3 を見て `differential_pressure_selected_pa` を復元し、GUI flow path は selected differential pressure 優先 / legacy placeholder fallback の両対応とした
