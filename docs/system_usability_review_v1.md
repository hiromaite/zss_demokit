...
- `P3-REL-001` は beta3 release notes と `tools/release_readiness_check.py` の first slice を完了した。既存 `v0.1.0-beta.2` tag と衝突しないよう、次配布候補は `0.1.0-beta.3` として扱う。installer / updater / signing は formal release 前の判断点として残す
